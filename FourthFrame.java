...
public class FourthFrame 
{
    ...
    public FourthFrame ()
    {
        ...
        Label l1 = new Label("H.A.S Bank Money Withdraw");
        ...
        u4.setText("Amount Withdrawal: ");
        u4.setFont(font3);

        Label u5=new Label();
        u5.setBounds(50, 450, 225, 25);
        u5.setText("Amount Deducted: ");
        u5.setFont(font3);
             ...
             {   
                 public void actionPerformed(ActionEvent e)
                    {  
                        ...
                        int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to continue?", "H.A.S Bank Money Withdraw", dialogButton);
                        if(dialogResult == 0) 
                        {
