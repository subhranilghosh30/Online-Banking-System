...
{
	private JFrame f = new JFrame("Transfer");
    Connection con;
    Statement s;
   // int acc=123456789;
    ...
    public ThirdFrame ()
    {
        ...
        Label l1 = new Label("H.A.S Bank Money Transfer");
        ...
        Label u=new Label();
        u.setBounds(50, 210, 200, 25);
        u.setText("Sender's Account Number*");
        u.setFont(font3);

        Label u1=new Label();
        u1.setBounds(50, 250, 225, 25);
        u1.setText("Total Amount");
        u1.setFont(font3);

       /* final Label u1=new Label();
        u1.setBounds(50, 250, 225, 25);
        u1.setText("Recipient's Account Number*");
        u1.setFont(font3);*/

        Label u2=new Label();
        u2.setBounds(50, 290, 225, 25);
        u2.setText("Recipient's Account Number*");
        u2.setFont(font3);

        Label u3=new Label();
        u3.setBounds(50, 330, 225, 25);
        u3.setText("Amount*");
        u3.setFont(font3);

        Label u4=new Label();
        u4.setBounds(50, 370, 225, 25);
        u4.setText("Amount Deducted: ");
        u4.setFont(font3);
        ...
        p2.setBounds(310, 290, 350, 25);  
        p2.setFont(font3);

        TextField p3=new TextField();
        p3.setBounds(310, 330, 350, 25);
        p3.setFont(font3);

        TextField p4=new TextField();
        p4.setBounds(310, 370, 350, 25);
        p4.setFont(font3);
        p4.getText();

        JButton g=new JButton("Send"); 
                 ...
                 public void actionPerformed(ActionEvent e)
                    {
                        ...
                        int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to continue?", "H.A.S Bank Money Transfer", dialogButton);
                        if(dialogResult == 0)
                        {
